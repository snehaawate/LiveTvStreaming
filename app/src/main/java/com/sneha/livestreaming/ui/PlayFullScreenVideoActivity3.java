...
public class PlayFullScreenVideoActivity3 extends ParentActivity {
        ...
        @SuppressLint("StaticFieldLeak") YouTubeExtractor mExtractor = new YouTubeExtractor(mContext) {
            ...
            protected void onExtractionComplete(SparseArray<YtFile> sparseArray, VideoMeta videoMeta) {
                ...
                if (sparseArray != null && sparseArray.get(18)!=null) {
                    ...
                    Toast.makeText(PlayFullScreenVideoActivity3.this, "Video not playing", Toast.LENGTH_SHORT).show();
