...
import com.sneha.livestreaming.Youtube.ExtractorException;
import com.sneha.livestreaming.Youtube.YoutubeStreamExtractor;
import com.sneha.livestreaming.Youtube.model.YTMedia;
import com.sneha.livestreaming.Youtube.model.YoutubeMeta;
import com.sneha.livestreaming.Youtube.utils.LogUtils;
import com.sneha.livestreaming.video_integration.ExoPlayerManager;
import com.sneha.livestreaming.youtubeExtractor.VideoMeta;
import com.sneha.livestreaming.youtubeExtractor.YouTubeExtractor;
import com.sneha.livestreaming.youtubeExtractor.YouTubeUriExtractor;
import com.sneha.livestreaming.youtubeExtractor.YtFile;
...
public class PlayFullScreenVideoActivity2 extends ParentActivity {
                ...
                *//*for(int i = 0, nsize = sparseArray.size(); i < nsize; i++) {
                ...
                if (sparseArray != null && sparseArray.get(18)!=null) {
                   ...
                   // AppLog.getInstance().printToast(mContext,"Error occured!");
                    Toast.makeText(PlayFullScreenVideoActivity2.this, "Video not playing", Toast.LENGTH_LONG).show();
