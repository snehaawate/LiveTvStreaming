...
public class SelectedChannelDetalActivity extends BaseActivity {
    ...
    private InnerChannelModel innerChannelModel;
       ...
       // setContentView(R.layout.activity_scrolling);
        ...
        if (intent != null) {
            if (intent.hasExtra("List")) {
                innerChannelModel = (InnerChannelModel) intent.getSerializableExtra("List");
                myFavoritemodel = RealamDatabase.getInstance().getMyFavorite(innerChannelModel.getChannels_id());
                setFavIcon();
                setData();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (a == 0) {
                    a = 1;
                    saveToFavorate(innerChannelModel);
                    myFavoritemodel.clear();
                    myFavoritemodel = RealamDatabase.getInstance().getMyFavorite(innerChannelModel.getChannels_id());
                    fab.setImageResource(R.drawable.ic_favorite);
                    Utility.showToastMessageShort(SelectedChannelDetalActivity.this, "Channel selected as Favorite");
                } else if (a == 1) {
                    a = 0;
                    deleteFavorate(innerChannelModel);
                    myFavoritemodel.clear();
                    myFavoritemodel = RealamDatabase.getInstance().getMyFavorite(innerChannelModel.getChannels_id());
                    fab.setImageResource(R.drawable.ic_un_favorite);
                    Utility.showToastMessageShort(SelectedChannelDetalActivity.this, "Channel selected as Non Favorite");
                }
        ...
        navigationShare.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Utility.shareApp(SelectedChannelDetalActivity.this);
            }
        });
       /* play_video.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (innerChannelModel.getChannel_type().equalsIgnoreCase("youtube")) {
                    Intent intent = new Intent(SelectedChannelDetalActivity.this, YouTubePlayerActivity.class);
                    intent.putExtra(YouTubePlayerActivity.EXTRA_VIDEO_ID, innerChannelModel.getChannels_url());
                    ...
                    startActivity(new Intent(SelectedChannelDetalActivity.this, VideoPlayerActivity.class).putExtra("ID", innerChannelModel.getChannels_url()));
                }
            }
        });*/


        if (innerChannelModel.getChannel_type().equalsIgnoreCase("youtube")&&innerChannelModel.getChannels_url()!=null) {
            ...
            mBinding.thumbnail.initialize(getResources().getString(R.string.youtube_api_key), new YouTubeThumbnailView.OnInitializedListener() {
                ...
                public void onInitializationSuccess(YouTubeThumbnailView youTubeThumbnailView, final YouTubeThumbnailLoader youTubeThumbnailLoader) {
                    ...
                    youTubeThumbnailLoader.setVideo(extractYTId("https://www.youtube.com/watch?v="+innerChannelModel.getChannels_url()));
                        ...
                        public void onThumbnailLoaded(YouTubeThumbnailView youTubeThumbnailView, String s) {
                            ...
                            mBinding.videoPanel.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    //intent.putExtra("video_link","https://www.youtube.com/watch?v="+innerChannelModel.getChannels_url());
                                    intent.putExtra("video_link",innerChannelModel.getChannels_url());
                                    startActivity(intent);
        ...
        } else if (innerChannelModel.getChannels_url()!=null){
            mBinding.videoPanel.setVisibility(View.VISIBLE);
            String url1,url = null;
            url  = innerChannelModel.getChannels_url();
    ...
    private void deleteFavorate(InnerChannelModel listOfAllLatestChannels) {
        RealamDatabase.getInstance().deleteRowInMyFavorate(listOfAllLatestChannels.getChannels_id());
    }

    private void saveToFavorate(InnerChannelModel listOfAllLatestChannels) {
    ...
    private void setData() {
        ...
        Glide.with(SelectedChannelDetalActivity.this).load(innerChannelModel.getChannels_image())
                .diskCacheStrategy(DiskCacheStrategy.ALL)
                .into(main_imageview_placeholder);
        title_text.setText(innerChannelModel.getChannels_name());
        date_text.setText(innerChannelModel.getCreated_at());
        description_text.setText(innerChannelModel.getChannel_description());
    }
